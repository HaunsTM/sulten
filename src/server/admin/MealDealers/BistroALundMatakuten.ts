...
export const BistroALundMatakutenDealer: IWebMealDealerStatic =  class BistroALundMatakutenDealerLocal {

    public static get baseUrlStatic(): string {
        const baseUrl = "https://www.amica.se/bistroalund?matakuten";
        return baseUrl;
    }
