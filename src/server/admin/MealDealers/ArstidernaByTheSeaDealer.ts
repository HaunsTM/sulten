...
export const ArstidernaByTheSeaDealer: IWebMealDealerStatic =  class ArstidernaByTheSeaDealerLocal {

    public static get baseUrlStatic(): string {
        const baseUrl = "http://arstidernabythesea.se/lunch/";
        return baseUrl;
    }
    ...
    public async mealsFromWeb(): Promise<IDealerResult> {
        ...
        const dealerResult = new DealerResult( ArstidernaByTheSeaDealer.baseUrlStatic, mealsForAWeekPromise );
    ...
    private xpathProvider( weekDay: string, label: LabelName, indexNumber: IndexNumber ): IXPathDishProviderResult {
        ...
        const commonWeekNumberXPath = `//h3[contains(.,'VECKANS')]`;
